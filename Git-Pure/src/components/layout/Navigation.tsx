...
export const Navigation: React.FC = () => {
  ...
  return (
    <nav className="h-full bg-white border-r border-neutral-200 md:w-64 relative z-10">
      {/* Desktop Navigation */}
      <div className="hidden md:block h-full">
        <div className="p-6">
          <div className="flex items-center gap-2 mb-8">
            ...
            <div>
              <h1 className="text-lg font-semibold text-neutral-900">CareXPS</h1>
              <p className="text-sm text-neutral-600">Healthcare CRM</p>
            </div>
          </div>
