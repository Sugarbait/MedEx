...
export const CallDetailModal: React.FC<CallDetailModalProps> = ({ call, isOpen, onClose }) => {
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="text-gray-900">{call.metadata?.patient_name || 'N/A'}</p>
                </div>
                <div>
                  <label className="text-sm font-medium text-gray-700">Phone Number</label>
                  <p className="text-gray-900">{call.phone_number || 'N/A'}</p>
                </div>
                <div>
                  <label className="text-sm font-medium text-gray-700">Call Type</label>
                  <p className="text-gray-900">{call.metadata?.call_type || call.call_type || 'N/A'}</p>
                </div>
                <div>
                  <label className="text-sm font-medium text-gray-700">Patient ID</label>
                  <p className="text-gray-900">{call.patient_id || 'N/A'}</p>
                </div>
              </div>
            </div>
                              ...
                              return (
                                <div key={index} className="flex items-start gap-3">
                                  ...
                                  <div className="flex-1">
                                    ...
                                    <p className="text-gray-800 leading-relaxed">{content.trim()}</p>
                                  </div>
                                </div>
                              )
                            } else if (keypadMatch) {
                              ...
                              {conversationParts.map((part, index) => {
                                ...
                                return (
                                  <div key={index} className="flex items-start gap-3">
                                    ...
                                    <div className="flex-1">
                                      <div className={`text-xs font-medium ${textColor} mb-1`}>{label}</div>
                                      <p className="text-gray-800 leading-relaxed">{part}</p>
                                    </div>
                                  </div>
                                )
                              })}
