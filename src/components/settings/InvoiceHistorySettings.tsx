      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-2xl font-bold text-green-900 dark:text-green-100">
                CAD ${totalUnpaid.toFixed(2)}
              </div>
              <div className="text-xs text-green-700 dark:text-green-300">Total Unpaid</div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-600 rounded-lg p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-2xl font-bold text-purple-900 dark:text-purple-100">{openInvoices}</div>
              <div className="text-xs text-purple-700 dark:text-purple-300">Unpaid Invoices</div>
            </div>
          </div>
        </div>
      </div>
                    ...
                    >
                      ...
                      <td className="px-4 py-3">
                        ...
                        >
                          ...
                          {invoice.status === 'open' ? 'Unpaid' : invoice.status.charAt(0).toUpperCase() + invoice.status.slice(1)}
                        </span>
                      </td>
                      <td className="px-4 py-3 text-sm text-gray-700 dark:text-gray-300">
