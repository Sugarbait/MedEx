    ...
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-4">
          ...
          <div className="text-3xl font-black text-blue-600 mb-1">
            {loading ? '...' : metrics.totalSMSSegments}
          </div>
          <div className="text-xs text-gray-500">
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-4">
          ...
          <div className="text-xs text-gray-500">
            {allFilteredChats.length > 0 ? `${((metrics.positiveSentimentCount / allFilteredChats.length) * 100).toFixed(1)}% positive` : '0% positive'}
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-4">
          ...
          <div className="text-3xl font-black text-blue-600 mb-1">
            {loading ? '...' : metrics.peakHour}
          </div>
          <div className="text-xs text-gray-500">
            {metrics.peakHourCount > 0 ? `${metrics.peakHourCount} chat${metrics.peakHourCount === 1 ? '' : 's'} at peak time` : 'No peak data'}
          </div>
        </div>
