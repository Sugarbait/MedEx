          ...
          <div className="p-6 space-y-6">
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="text-gray-900">{message.metadata?.patient_name || 'N/A'}</p>
                </div>
                <div>
                  <label className="text-sm font-medium text-gray-700">Phone Number</label>
                  <p className="text-gray-900">{message.phone_number}</p>
                </div>
                <div>
                  <label className="text-sm font-medium text-gray-700">Patient ID</label>
                  <p className="text-gray-900">{message.patient_id}</p>
                </div>
                <div>
                  <label className="text-sm font-medium text-gray-700">Message Type</label>
                  <p className="text-gray-900">{message.metadata?.message_type || 'N/A'}</p>
                </div>
                {message.metadata?.chat_id && (
                  <div className="md:col-span-2">
                    <label className="text-sm font-medium text-gray-700">Chat ID</label>
                    <p className="text-gray-900 font-mono text-sm">{message.metadata.chat_id}</p>
                  </div>
                )}
              </div>
            </div>
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              ...
              <div className="bg-white rounded border p-4">
                <p className="text-gray-900 leading-relaxed whitespace-pre-wrap">{message.message_content}</p>
              </div>
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                <div>
                  <label className="text-gray-700 font-medium">Message ID</label>
                  <p className="text-gray-600 font-mono">{message.message_id}</p>
                </div>
                <div>
                  <label className="text-gray-700 font-medium">Direction</label>
                  <p className="text-gray-600 capitalize">{message.direction}</p>
                </div>
                <div>
                  <label className="text-gray-700 font-medium">Timestamp</label>
                  <p className="text-gray-600">{new Date(message.timestamp).toISOString()}</p>
                </div>
                <div>
                  <label className="text-gray-700 font-medium">Status</label>
                  <p className="text-gray-600 capitalize">{message.status}</p>
                </div>
              </div>
            </div>
